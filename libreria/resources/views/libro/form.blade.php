<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <input type="text" name="categoria_id" class="form-control @error('categoria_id') is-invalid @enderror"
            value="{{ old('categoria_id', $libro?->categoria_id) }}" id="categoria_id" placeholder="Categoria Id">
